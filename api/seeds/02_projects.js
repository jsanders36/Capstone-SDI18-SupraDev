...
exports.seed = async function(knex) {
  ...
  await knex('project_table').insert([
    ...
    {name: 'Environmental Monitoring Dashboard', problem_statement: "Environmental data collection is vital, but our current systems are outdated. We need a modern dashboard that can aggregate and visualize data from various sensors for better decision-making in environmental management.", submitter_id: 1, is_approved: true, is_accepted: true, accepted_by_id: 5, is_completed: true, bounty_payout: 500, github_url: 'https://github.com/'},
